...
public class Color_Space_Converter implements PlugInFilter {
	 ...
	 * ColorSpaceConverter
	 * 
	 * @author dvs, hlp Created Jan 15, 2004 Version 3 posted on ImageJ Mar 12, 2006 by Duane Schwartzwald vonschwartzwalder at mac.com Version 4 created Feb. 27, 2007 by Harry
	 *         Parker, harrylparker at yahoo dot com, corrects RGB to XYZ (and LAB) conversion.
	 */
	...
	// about
	void showAbout() {
		IJ.showMessage("About Color Space Calculator...", "This plug-in filter converts an image to a different color space.\n");
	}
	...
	public void wepi_run(ImageProcessor ip, Object... objects) {
		if (!setParams(objects))
			return;
	...
	public int wepi_setup(String arg, ImagePlus imp, Object... objects) {
		if (imp != null) {
			title = imp.getTitle();
